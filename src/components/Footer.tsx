        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pb-6 border-b border-slate-800">
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-2 text-slate-100 font-bold text-sm">
              <span className="w-6 h-6 rounded bg-amber-500 text-slate-950 flex items-center justify-center font-black text-xs">
                UAM
              </span>
          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-col gap-1 text-[11px]">
              <span className="text-red-400">● 1 a 5.9: Rojo / Riesgo Crítico (Requiere salvaguardas inmediatas)</span>
              <span className="text-amber-400">● 6 a 8.9: Amarillo / Riesgo Moderado (Requiere mejoras técnicas/normativas)</span>
              <span className="text-emerald-400">● 9 a 10: Verde / Cumplimiento Óptimo (Alineado con directrices)</span>
            </div>
          </div>
